...
#  Created by Genus(TM) Synthesis Solution 21.14-s082_1 on Mon Mar 09 11:47:23 IST 2026
...
set_load -pin_load 0.15 [get_ports {y[31]}]
set_load -pin_load 0.15 [get_ports {y[30]}]
set_load -pin_load 0.15 [get_ports {y[29]}]
set_load -pin_load 0.15 [get_ports {y[28]}]
set_load -pin_load 0.15 [get_ports {y[27]}]
set_load -pin_load 0.15 [get_ports {y[26]}]
set_load -pin_load 0.15 [get_ports {y[25]}]
set_load -pin_load 0.15 [get_ports {y[24]}]
set_load -pin_load 0.15 [get_ports {y[23]}]
set_load -pin_load 0.15 [get_ports {y[22]}]
set_load -pin_load 0.15 [get_ports {y[21]}]
set_load -pin_load 0.15 [get_ports {y[20]}]
set_load -pin_load 0.15 [get_ports {y[19]}]
set_load -pin_load 0.15 [get_ports {y[18]}]
set_load -pin_load 0.15 [get_ports {y[17]}]
set_load -pin_load 0.15 [get_ports {y[16]}]
set_load -pin_load 0.15 [get_ports {y[15]}]
set_load -pin_load 0.15 [get_ports {y[14]}]
set_load -pin_load 0.15 [get_ports {y[13]}]
set_load -pin_load 0.15 [get_ports {y[12]}]
set_load -pin_load 0.15 [get_ports {y[11]}]
set_load -pin_load 0.15 [get_ports {y[10]}]
set_load -pin_load 0.15 [get_ports {y[9]}]
set_load -pin_load 0.15 [get_ports {y[8]}]
...
set_input_transition 0.12 [get_ports {f[2]}]
set_input_transition 0.12 [get_ports {f[1]}]
set_input_transition 0.12 [get_ports {f[0]}]
