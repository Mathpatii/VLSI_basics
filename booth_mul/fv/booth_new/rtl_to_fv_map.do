...
# Generated on: Mon Mar 02 13:25:34 IST 2026 (Mon Mar 02 07:55:34 UTC 2026)
...
set logfile fv/booth_new/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/booth_new -revised fv_map
...
add_search_path /home/vlsi/Desktop/1dt23ec097/booth_mul -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/vlsi/Desktop/1dt23ec097/booth_mul/booth_multiplier.v
elaborate_design -golden -root {booth_new} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/booth_new/fv_map.v.gz
elaborate_design -revised -root {booth_new}
...
#add_name_alias fv/booth_new/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.booth_new.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.booth_new.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.booth_new.rtl.fv_map.rpt
