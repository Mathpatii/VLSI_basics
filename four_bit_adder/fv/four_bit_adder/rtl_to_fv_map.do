...
# Generated on: Mon Feb 23 12:50:32 IST 2026 (Mon Feb 23 07:20:32 UTC 2026)
...
set logfile fv/four_bit_adder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/four_bit_adder -revised fv_map
...
add_search_path /home/vlsi/Desktop/1dt23ec097/four_bit_adder -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/vlsi/Desktop/1dt23ec097/four_bit_adder/adder.v
elaborate_design -golden -root {four_bit_adder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/four_bit_adder/fv_map.v.gz
elaborate_design -revised -root {four_bit_adder}
...
set_system_mode lec
write_compared_points noneq.compared_points.four_bit_adder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.four_bit_adder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.four_bit_adder.rtl.fv_map.rpt
